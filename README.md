...
「今日の天気どうかな」を見たあと、結局「で、何着る？傘いる？」を自分でやってる時間が地味に長い、という不満から作った小さな PWA。気圧・気温・降水・花粉の数字を表示するだけにせず、服装・持ち物・アクションのカードに翻訳して 1 画面に並べるのが軸です。マスコットの「そら」と「リス」が、空の変化に合わせて今日の支度をそっと用意してくれます。ミニアプリ Week 第 2 弾（m-w-02）の個人 MVP。
